...
/**
 * Get order tracking status from ClickPost
 * @param {object} params
 * @param {string} params.awb - shipment tracking/waybill number
 * @param {object} params.shopifyOrder - shopify order (used to derive cp_id from tracking url)
 * @returns {object} - { success, current_status, tracking_data } or { success:false, error }
 */
